...
export default async function SavedLeaguesPage() {
  ...
  return (
    <div className="page-wrap">
      <section className="hero-panel">
        <div><p className="eyebrow">PERSISTENT LEAGUE INTELLIGENCE</p><h1>Your saved WAR ROOM leagues.</h1><p className="lede">Saved leagues preserve the manager identity needed to reopen lineup, waiver, breakout, trade and championship intelligence without reconnecting the roster.</p></div>
